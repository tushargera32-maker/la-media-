...
const navigationItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v11a2 2 0 002 2z" />
      </svg>
    ),
  },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white min-h-screen flex flex-col shadow-2xl">
      <div className="p-6 border-b border-gray-800/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold leading-tight">LA Media</h1>
        ...
        {navigationItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute right-3 top-1/2 -translate-y-1/2 h-2 w-2 rounded-full bg-white"></span>
              )}
            </Link>
          );
        })}
