...
export const metadata: Metadata = {
  title: "Register",
  description: `Register for ${EVENT.name} ${EVENT.city} - ${EVENT.tagline}`,
};

/*
  Split composition from the reference: event story on the left over
  imagery, form on the right. This route sits OUTSIDE the (site) group
  on purpose - no site header or footer competing with the form.
*/
export default function RegisterPage() {
  return (
    <div className="min-h-screen">
      {/* Slim bar instead of the full site header. */}
